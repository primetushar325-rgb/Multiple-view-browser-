...
class SettingsRepo(private val context: Context) {
    ...
    private val kAdblockMode = stringKey("adblock_mode")
    ...
    val adblockMode: Flow<String> = store.data.map { it[kAdblockMode] ?: "normal" }
    ...
    suspend fun setAdblockMode(v: String) = store.edit { it[kAdblockMode] = v }
